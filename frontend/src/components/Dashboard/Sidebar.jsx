  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 z-20 transform lg:relative lg:translate-x-0 transition duration-300 ease-in-out
          ...
          w-64 lg:w-72 bg-slate-900 p-6 flex flex-col text-white shadow-xl`}
    >
      <div className="flex items-center mb-10 group cursor-pointer transition-transform hover:scale-105">
