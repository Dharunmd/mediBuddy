    ...
    if (analysisCompleted) {
      ...
      return (
        <button
          ...
          className={`px-6 py-2.5 bg-gradient-to-r from-brand-500 to-blue-500 text-white rounded-xl font-medium shadow-sm hover:shadow-md transition-all cursor-pointer
            ${
          ...
          <div className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col">
              ...
              <input
                ...
                className={`border ${formErrors.patientName ? 'border-red-500' : 'border-slate-300'} rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-brand-500`}
                required
              />
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                className={`border ${formErrors.phoneNumber ? 'border-red-500' : 'border-slate-300'} rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-brand-500`}
              />
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                className="border border-slate-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-brand-500 bg-white"
              >
                ...
                <>
                  ...
                  <div className="flex flex-wrap justify-center gap-2 max-w-2xl">
                    {selectedFiles.map((file, index) => (
                      ...
                      >
                        <Image size={16} className="text-brand-500 mr-2" />
                    ...
                    <div className={`p-3 ${result.isError ? 'bg-red-50' : 'bg-slate-50'} border-b`}>
                      ...
                      {!result.isError && !result.processing && (
                        <p className="text-sm font-medium text-brand-600">
                          Tumor type: <span className="bg-brand-100 px-2 py-0.5 rounded-full">{result.prediction || "Unknown"}</span>
                        </p>
                      )}
                      {result.processing && (
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white rounded-xl shadow-xl p-6 max-w-md w-full mx-4 animate-fade-in">
                <div className="flex flex-col items-center text-center">
                  ...
                  <button
                    onClick={clearForm}
                    className="px-6 py-2.5 bg-gradient-to-r from-brand-500 to-blue-500 text-white rounded-xl font-medium shadow-sm hover:shadow-md transition-all cursor-pointer w-full"
                  >
                    Continue
                  </button>
                </div>
